...
import com.rijal.salesandcredit.databinding.FragmentCapitalInjectionListBinding
...
class CapitalInjectionListFragment : Fragment() {

    lateinit var parent: DetailActivity
    lateinit var binding: FragmentCapitalInjectionListBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCapitalInjectionListBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parent.setToolbarTitle("Suntikan Modal")
        ...
        adapter = object : EasyAdapter(R.layout.item_transaction_list, viewModel.transactionList.valueOrDefault()) {
            override fun onBindViewHolder(holder: EasyViewHolder, position: Int) {
                ...
                holder.itemView.findViewById<CardView>(R.id.cv_detail).setOnClickListener {
                    findNavController().navigate(CapitalInjectionListFragmentDirections.actionCapitalInjectionListFragmentToCapitalInjectionDetailFragment(selectedData.transactionId))
                }
                holder.itemView.findViewById<CardView>(R.id.cv_invoice).setOnClickListener {
                    findNavController().navigate(CapitalInjectionListFragmentDirections.actionCapitalInjectionListFragmentToInvoiceListFragment(selectedData.transactionId))
                }
            }
        }
    ...
    private fun initListener() {
        ...
        binding.fabAddNew.setOnClickListener {
            findNavController().navigate(CapitalInjectionListFragmentDirections.actionCapitalInjectionListFragmentToCapitalInjectionDetailFragment(0))
        }
    }
